...
const PrivacyPolicy = () => (
    <Layout>
        <TextWrapper>
            ...
            <p style={{ textAlign: 'center', fontSize: 'var(--footnote)', margin: '-10px' }}>Last update April 1, 2022</p>
            <h2>Introduction</h2>
            <p>
            ...
            <p>
                Gitpod respects the privacy of its customers, partners and visitors to its Website.We are committed to protecting the personal information that you share with us. We believe that you have a right to know how and why we collect your information and to know what measures we take to protect it. This Privacy Policy is intended on providing you with such information.
            </p>
            <p>

                By accessing and/or using our Website and Services you agree to the terms and conditions set forth in this Privacy Policy, including the collection and processing of your personal information.
            </p>

            <h2>Data Controller</h2>
            <p>
                The data controller for all processing activities in the context of this Website is Gitpod, unless stated otherwise.
            </p>
            <p>
                Gitpod GmbH
                <br />
                ...
                24143 Kiel, Germany
                <br />
                Email: <a href="mailto:contact@gitpod.io">contact@gitpod.io</a>
            </p>
            ...
            <p>
                Identifiable information is collected when you access or use the Website and/or the Services. We use industry standard tools and software to monitor your navigation and usage of the Website and Services, your usage pattern-logs and other communications data. We may also use “cookies” and Flash (or similar technologies), which store certain information on your computer (“Local Storage”) and which allow us to enable automatic activation of certain features to improve your experience.
            </p>

            <p>
                Depending on the type of access log used, the log file may contain the following information:
            </p>
            ...
            <p>
                The data stored in the log files is used exclusively for the purposes of identifying and tracking unauthorized access attempts/accesses to the web server and for statistical analyses, such as the number of visitors and the popularity of a page. Such analyses are only carried out by authorized employees of Gitpod.
            </p>

            <h2>Data Protection</h2>

            <p>Gitpod uses industry standard technologies and internal procedures to maintain the security and integrity of our Website, Services and your information, as well as to prevent unauthorized access thereto. Please note, however, that there are inherent risks in the transmission of information over the internet or other methods of electronic storage and we cannot guarantee that unauthorized access or use of your information will never occur.</p>
            ...
            <h4>Newsletter</h4>
            <p>
                Personal data entered into forms on our website will be transmitted to Gitpod via a secure connection in encrypted form. If you have signed up or otherwise agreed to receive newsletters, we will process your contact data to render those services. All newsletter activities and other update services serve marketing purposes and business development.
            </p>
            ...
            <p>
                The Google Analytics Terms of Service can be found here: <a href="http://www.google.com/analytics/terms/us.html" target="_blank">http://www.google.com/analytics/terms/us.html</a>
            </p>

            <p>
                Further information about privacy at Google and additional terms can be found here: <a href="https://policies.google.com/" target="_blank">https://policies.google.com/</a>
            </p>

            <h2>Cookie Policy</h2>

            <p>
                Gitpod uses cookies when you visit our Website. Cookies are small text files placed on your device by our web application that allow us to identify your web browser. Most browsers are set to automatically accept cookies. You have the ability to deactivate cookies, however, or set your browser to inform you about the use of cookies.
            </p>
            ...
            <p>
                Session cookies are only stored on your system until you end your current browser session. They are used to ensure that you can use the features of our website without limitation during your visit to our site. This data is anonymized so that you are not personally identifiable.
            </p>
            ...
            <p>
                The EU’s General Data Protection Regulation (“GDPR”) and other countries’ privacy laws provide certain rights for data subjects. Useful information regarding the GDPR (in English) is available on the following EU website. <a href="https://ec.europa.eu/info/law/law-topic/data-protection_en" target="_blank">https://ec.europa.eu/info/law/law-topic/data-protection_en</a>
            </p>

            <p>Every user has the right to receive information about the data stored about them by Gitpod, free of charge.</p>

            <p>In addition, every user has the following rights with regard to their personal data:</p>
            ...
            <p>You have also the right to lodge a complaint with a supervisory authority at your choice. An overview of the European National Data Protection Authorities may be found here: <a href="http://ec.europa.eu/newsroom/article29/item-detail.cfm?item_id=612080" target="_blank">http://ec.europa.eu/newsroom/article29/item-detail.cfm?item_id=612080</a></p>

            <h2>Changes to Privacy Policy</h2>
            <p>The terms of this Privacy Policy will govern the use of the Website and Services and any information collected by Gitpod. Gitpod reserves the right to change this policy at any time, so please re-visit this page frequently. We will provide notice of substantial changes to this policy on the homepage of the Website. All other changes to this Privacy Policy are effective as of the stated “Last Updated” date and your continued use of the Website and the Services after the Last Update date will constitute acceptance of, and agreement to be bound by, those changes. If the Privacy Policy is required to be amended to comply with any legal requirements, the amendments may take effect immediately, or as required by the law and without any prior notice.</p>

            <h2>Minors</h2>
            <p>The Website is intended for users over the age of eighteen (18). Therefore, Gitpod does not intend and does not knowingly collect personal data from children under the age of eighteen (18). Gitpod reserves the right to request proof of age. If Gitpod noted that personal data from children under the age of eighteen (18) were collected, Gitpod will delete that information promptly. Please contact <a href="mailto:contact@devxconf.org" target="_blank">contact@devxconf.org</a> if you have reasons to suspect that Gitpod collected such information.</p>

            <h2 className="heading-quadrary" style={{color: 'var(--white)', textAlign: 'left'}}>Got Any Questions?</h2>
            <p>We are committed to protecting your privacy. If you have any questions (or comments) concerning this Privacy Policy, you are more than welcome to send us an email to the following address: <a href="mailto:contact@devxconf.org" target="_blank">contact@devxconf.org</a> and we will make an effort to reply within a reasonable timeframe.</p>
        </TextWrapper>
    </Layout>
);
