  ...
  return (
    <div className="row">
      ...
      <div className={styles['support-item']}>
        ...
        <p>
          We're not, where we'd like to be. So we have to keep fighting for your values. For that we
          started a donation initative.
        </p>
        <p>
          For every registration to our discord channel we'll donate $1 to a non-profit organisation
          that we support. Would you like to join us?
        </p>
        <a
          role="button" 
